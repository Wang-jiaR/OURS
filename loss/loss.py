...
def make_loss(cfg, num_classes):
    ...
    if 'triplet' in cfg.MODEL.METRIC_LOSS_TYPE:   #  _C.MODEL.METRIC_LOSS_TYPE = 'triplet'
        if cfg.MODEL.NO_MARGIN:       #  _C.MODEL.NO_MARGIN = False
            triplet = TripletLoss()
    ...
    if cfg.MODEL.IF_LABELSMOOTH == 'on':     #某些情况下用标签平滑
    ...
    elif cfg.DATALOADER.SAMPLER == 'softmax_triplet':    #原配置文件都是softmax，后面调用的都是softmax_triplet
